// ---------------------------- EASING methods -----------------------------
// NOTE: THESE WERE TAKEN STRAIGHT FROM THE GICENTRE UTILS LIBRARY (https://github.com/gicentre/gicentreutils)
// THIS WAS DONE FOR THE SAKE OF JAVASCRIPT PORTABILITY
